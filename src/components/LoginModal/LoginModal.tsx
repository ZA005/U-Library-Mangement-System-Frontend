...
import Visibility from '@mui/icons-material/Visibility'; // Icon for toggling
import AccountCircle from '@mui/icons-material/LibraryBooks'; // Icon for Library Card Number
