...
const FirstPage: React.FC<FirstPageProps> = ({ onNext, formData, setFormData }) => {
    ...
    return (
        <Box display="grid" gap={2}>
            ...
            <TextField fullWidth label="Published Date" name="publishedDate" value={formData.publishedDate} onChange={handleChange} />
            <TextField fullWidth label="Pages" name="pages" value={formData.pages} onChange={handleChange} />
